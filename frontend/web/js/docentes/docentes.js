$(document).ready(function () {
    ...
    $("#vistaCrearDocnetePestañas").hide();
    //$(".entrada-datos").hide();

    $("#btnCancelar").click(function () {
        $("#vistaDocentes").show(300);
        $("#vistaFuncionarios").hide(300);
        $("#vistaCrearDocentePestañas").hide(300);
    });
});
/*=============================================
CARGAR LA TABLA DINÁMICA DE DOCENTES
=============================================*/
$(".tablaDocentes").DataTable({
    ...
    ajax: {
        ...
        dataType: 'json',
        cache: false,
        url: 'index.php?r=Filiacion/docentes/listar-docentes',
        data: {}
    },
    "responsive": true,
    "retrieve": true,
...
$(".tablaFuncionarios").DataTable({
    ...
    ajax: {
        ...
        dataType: 'json',
        cache: false,
        url: 'index.php?r=Filiacion/docentes/listar-funcionarios',
        data: {}
    },
    "responsive": true,
    "retrieve": true,
...
ACTIVAR DOCENTE
=============================================*/
$(".tablaDocentes tbody").on("click", ".btnActivar", function () {
    let objectBtn = $(this);
    ...
    $.ajax({
        url: "index.php?r=Filiacion/docentes/activar-docente-ajax",
        method: "POST",
        data: datos,
        cache: false,
        contentType: false,
        ...
        success: function (respuesta) {
            if (respuesta === "ok") {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: "Ocurrio un error al cambiar el estado del docente  con código " + codigo + ". Comuniquese con el administrador del sistema.",
...
/*=============================================
MOSTRAR CREAR DOCENTE
=============================================*/
$("#btnMostrarCrearDocente").click(function () {
    $("#vistaDocentes").hide(300);
...
$("#tablaFuncionarios tbody").on("click", ".btnElegir", function () {
    ...
    $("#vistaDocentes").hide(300);
    $("#vistaFuncionarios").hide(300);
    $("#vistaCrearDocentePestañas").show(300);
...
$(".codigoSectorTrabajo").change(function () {
    ...
    if (sector != "") {
        ...
        $.ajax({
            url: "index.php?r=Filiacion/docentes/listar-condiciones-laborales-ajax",
            method: "POST",
            dataType: 'html',
            data: datos,
            cache: false,
    ...
    if (sector != "") {
        ...
        datos.append("codigosectortrabajo", sector);
        $.ajax({
            url: "index.php?r=Filiacion/docentes/listar-niveles-salariales-ajax",
            method: "POST",
            dataType: 'html',
            data: datos,
            cache: false,
...
$("#btnCrearDocente").click(function () {
    ...
    $.ajax({
        url: "index.php?r=Filiacion/docentes/crear-docente-ajax",
        method: "POST",
        data: datos,
        cache: false,
        contentType: false,
...
=============================================*/
$(".tablaDocentes tbody").on("click", ".btnEditarDocente", function () {
    ...
    $.ajax({
        url: "index.php?r=Filiacion/docentes/buscar-docente-ajax",
        method: "POST",
        data: datos,
        cache: false,
        contentType: false,
        ...
        success: function (respuesta) {
            if (respuesta != "error") {
                ...
                datos.append("codigosectortrabajo", respuesta["CodigoSectorTrabajo"]);
                $.ajax({
                    url: "index.php?r=Filiacion/docentes/listar-cargos-ajax",
                    method: "POST",
                    dataType: 'html',
                    data: datos,
                    cache: false,
...
$("#btnActualizarDocente").click(function () {
    ...
    $.ajax({
        url: "index.php?r=Filiacion/docentes/actualizar-docente-ajax",
        method: "POST",
        data: datos,
        cache: false,
        contentType: false,
        ...
        success: function (respuesta) {
            if (respuesta === "ok") {
                $("#modalActualizarDocente").modal('hide');
                Swal.fire({
                    icon: "success",
